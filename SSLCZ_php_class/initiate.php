...
$post_data['success_url'] = "http://localhost/SSLCZ_php_class/complete.php";
$post_data['fail_url'] = "http://localhost/SSLCZ_php_class/complete.php";
$post_data['cancel_url'] = "http://localhost/SSLCZ_php_class/complete.php";
