									...
									<div class="product">
										<div class="tab-content">
											...
											<div role="tabpanel" class="tab-pane fade in  active" id="display-1-2">
												...
												<?php 
													$Searchproduct = $control->search_prod($_GET['search']);
													
													if($Searchproduct['status'] == false)
													{ 
														echo "News products are upcoming! Keep visiting! Get lost!"; 
													}
													else
														foreach($Searchproduct['data'] AS $sProduct)
														{
															echo '
															<div class="col-md-3 col-sm-4 col-xs-12">
															<div class="single-product">
																...
																<div class="product-img">
																	<a href="details?id='.$sProduct['prod_id'].'">
																		<img class="primary-img" src="admin/gallery/products/'.$sProduct['prod_pic_1'].'" alt="Product">
																		<img class="secondary-img" src="admin/gallery/products/'.$sProduct['prod_pic_2'].'" alt="Product">
																	</a>
																</div>
																<div class="product-description">
																	<h5><a href="details?id='.$sProduct['prod_id'].'">'.$sProduct['prod_name'].'</a></h5>
																	<div class="price-box">
																		<span class="price">'.$sProduct['prod_price'].'</span>
																		<!--<span class="old-price">$110.00</span>-->
																	</div>
																	<span class="rating">
																		<i class="fa fa-star"></i>
